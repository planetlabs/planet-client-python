...
class FeaturesAPI:
    ...
    def update_item(self, collection_id: str, feature_id: str, feature: Union[dict, GeoInterface]) -> Feature:
        """
        ...
        """
        return self._client._call_sync(
            self._client.update_item(collection_id, feature_id, feature))
