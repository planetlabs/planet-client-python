...
import time
from typing import Any, AsyncIterator, Awaitable, Callable, Dict, Iterator, List, Optional, TypeVar
import uuid
...
class DataAPI:
    ...
    @docstring(DataClient.create_search.__doc__)
    def create_search(
        self,
        item_types: List[str],
        search_filter: Dict,
    ...
    @docstring(DataClient.update_search.__doc__)
    ...
    @docstring(DataClient.list_searches.__doc__)
    ...
    @docstring(DataClient.get_stats.__doc__)
    def get_stats(self,
                  item_types: List[str],
                  search_filter: Dict[str, Any],
    ...
    @docstring(DataClient.download_asset.__doc__)
    ...
    @staticmethod
    @docstring(DataClient.validate_checksum.__doc__)
