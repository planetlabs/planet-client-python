...
class PlanetLegacyAuthClient(AuthClient):
    ...
    def _checked_auth_request(self, auth_data):
        response = requests.post(
            self._legacy_client_config.legacy_auth_endpoint, json=auth_data)
