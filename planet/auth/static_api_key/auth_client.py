...
from planet.auth.static_api_key.request_authenticator import FileBackedAPIKeyRequestAuthenticator
...
class StaticApiKeyAuthClient(AuthClient):
    ...
    def default_request_authenticator(self, token_file_path: pathlib.Path) -> FileBackedAPIKeyRequestAuthenticator:
        return FileBackedAPIKeyRequestAuthenticator(
            auth_file=FileBackedAPIKey(
